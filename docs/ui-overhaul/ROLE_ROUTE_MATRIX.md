...
- The canonical server matrix now separates portfolio management, contribution/proposal, client review, and Valo quality authority. Client/partner administrators do not inherit requirement confirmation, evidence approval, defect disposition, or quality sign-off; bid managers and analysts may confirm requirements but cannot approve evidence or sign off; only the named client reviewer and Valo quality role receive independent approval permissions. Every role is table-tested across the approval, review, sign-off, and export permissions.
