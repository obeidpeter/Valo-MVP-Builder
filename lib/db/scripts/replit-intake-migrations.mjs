...
export function validateReplitMigrationJournal(rows) {
  ...
  if (
    ![3, 6, 7, 8, 9, 10, 11, 12, EXPECTED_REPLIT_MIGRATIONS.length].includes(
      rows.length,
    )
  ) {
    fail("production journal is not an approved prefix through 0012");
  }
...
export async function validateLocalReplitMigrationManifest() {
  ...
  if (
    ...
    fail("source migration journal is not the frozen thirteen-entry manifest");
  }
