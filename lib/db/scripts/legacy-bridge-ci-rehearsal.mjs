...
async function main() {
  ...
  const expectedJournal = [
    ...
    1786339224638, 1786425600000, 1786622400000,
  ].map((createdAt, index) => ({
  ...
  try {
    ...
    console.log(
      "legacy bridge CI: adopted v2.5 journal plus additive public-intake migrations reconciled without public-data drift",
    );
