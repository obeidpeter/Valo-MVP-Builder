...
export function validateReplitMigrationJournal(rows) {
  ...
  if (![3, 6, EXPECTED_REPLIT_MIGRATIONS.length].includes(rows.length)) {
    fail(
      "production journal is not the approved 0000-0002, 0000-0005, or 0000-0006 state",
    );
  }
  ...
  return rows.length === 6 ? "upgrade_pending" : "pending";
}
