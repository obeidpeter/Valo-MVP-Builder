...
export const EXPECTED_REPLIT_MIGRATIONS = Object.freeze([
  ...
  Object.freeze({
    ...
    hash: "f952ab83015332682ebcc87287c16ba62996d4dce380429ef2d071319f627aa6",
  }),
]);
...
export function validateReplitMigrationJournal(rows) {
  ...
  if (
    ![3, 6, 7, 8, 9, 10, 11, EXPECTED_REPLIT_MIGRATIONS.length].includes(
      rows.length,
    )
  ) {
    fail("production journal is not an approved prefix through 0011");
  }
...
export async function validateLocalReplitMigrationManifest() {
  ...
  if (
    ...
    fail("source migration journal is not the frozen twelve-entry manifest");
  }
