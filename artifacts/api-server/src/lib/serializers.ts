...
export function serializeProject(
  ...
  return {
    ...
    physicalArchiveInstruction: p.physicalArchiveInstruction ?? null,
    redactionScope: p.redactionScope ?? null,
...
export function serializeBoqCheck(b: any) {
  return {
    ...
    quantityRaw: b.quantityRaw ?? null,
    unitRateKobo: b.unitRateKobo ?? null,
    extensionKobo: b.extensionKobo ?? null,
    computedExtensionKobo: b.computedExtensionKobo ?? null,
...
export function serializeCapabilityItem(c: any, evidenceDocName?: string | null) {
  return {
    ...
    verifierName: c.verifierName ?? null,
