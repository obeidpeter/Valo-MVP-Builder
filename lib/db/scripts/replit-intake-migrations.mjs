...
export const EXPECTED_REPLIT_MIGRATIONS = Object.freeze([
  ...
  Object.freeze({
    ...
    hash: "4bbe1b4f14292e8be8b76fce18fcea30dd7849ee2ea85995bab9936b18a0529e",
  }),
]);
...
export function validateReplitMigrationJournal(rows) {
  ...
  if (
    ![3, 6, 7, 8, 9, 10, EXPECTED_REPLIT_MIGRATIONS.length].includes(
      rows.length,
    )
  ) {
    fail("production journal is not an approved prefix through 0010");
  }
...
export async function validateLocalReplitMigrationManifest() {
  ...
  if (
    ...
    fail("source migration journal is not the frozen eleven-entry manifest");
  }
