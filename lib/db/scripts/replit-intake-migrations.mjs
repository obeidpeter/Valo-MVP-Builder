...
export function validateReplitMigrationJournal(rows) {
  ...
  if (
    ![3, 6, 7, 8, 9, EXPECTED_REPLIT_MIGRATIONS.length].includes(rows.length)
  ) {
    fail(
      "production journal is not the approved 0000-0002, 0000-0005, 0000-0006, 0000-0007, 0000-0008, or 0000-0009 state",
    );
  }
...
export async function validateLocalReplitMigrationManifest() {
  ...
  if (
    ...
    fail("source migration journal is not the frozen ten-entry manifest");
  }
